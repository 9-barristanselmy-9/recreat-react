...
})({"7B9u7":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "f7255fdf25c5b7db";
"use strict";
...
},{}],"9mLei":[function(require,module,exports,__globalThis) {
...
function createElement(type, props, ...children) {
    ...
    const element = {
        ...
        props: {
            ...props,
            children: flatchildren.flatMap((child)=>typeof child === "string" || typeof child === "number" ? createTextElement(String(child)) : child)
        }
    };
    return element;
}
...
},{}],"8aXUx":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _updateDom = require("../dom/updateDom");
function reconcile(element, domNode, oldDomNode) {
    ...
    if (element.type === "PLAIN_TEXT") {
        if (oldDomNode?.dom) element.dom = oldDomNode.dom;
        else {
    ...
    if (!oldDomNode) {
        ...
        (0, _updateDom.updateDom)(dom, {}, element.props);
        element.dom = dom;
        domNode.appendChild(element.dom);
    } else {
        //update
        element.dom = oldDomNode.dom;
        (0, _updateDom.updateDom)(element.dom, oldDomNode.props, element.props);
    }
    //reconcile children
    const oldChildren = oldDomNode?.props.children || [];
    const newChildren = element.props.children;
    newChildren?.forEach((childElement, index)=>{
        reconcile(childElement, element.dom, oldChildren[index]);
    });
}

},{"../dom/updateDom":"16Ahh","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"16Ahh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateDom", ()=>updateDom);
const isEvent = (key)=>{
...
function updateDom(domNode, prevProps, nextProps) {
    ...
    Object.keys(nextProps).forEach((name)=>{
        if (name === "children") domNode.setAttribute("class", nextProps[name]);
        else domNode[name] = nextProps[name];
    });
    // add event listeners
